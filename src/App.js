...
import { 
  ...
  Facebook, Sun, Quote, Image as ImageIcon, Utensils, Anchor, CheckCircle2
} from 'lucide-react';
  ...
  const scoutTrailData = [
    {
      ...
      month: 'August',
      year: '2026',
      milestones: ['Sea Base High Adventure', '7 Eagle Projects', 'Museum Tag Sale', 'Church Playground Service'],
      heroImg: '/images/scout-corner/2026-08-eagle-workday.jpg',
      heroFallback: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80',
      ...
      scoutRank: "Sea Base Crew Member",
      scoutImg: '/images/scout-corner/sheldon.jpg',
      scoutFallback: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=400&q=80',
      gallery: [
          ...
          <div className="flex justify-between h-24 items-center">
            ...
            <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => setCurrentPage('home')}>
              <div className="w-20 h-20 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                <img 
                  src="/images/logo.png" 
                  onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=150&q=80"; }} 
          ...
          <div className="animate-in fade-in duration-700">
            <div className="relative pt-32 pb-40 lg:pt-48 lg:pb-56 px-6 sm:px-8 lg:px-12 overflow-hidden" style={{ backgroundColor: darkBg }}>
              <div className="absolute inset-0 z-0">
                <img 
                  src="/images/hero.jpg" 
                  onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=1600&q=80'; }}
                  alt="Scouts" 
                  className="w-full h-full object-cover object-[100%_70%] -scale-x-100 opacity-90" 
                />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                     <div className="lg:col-span-7">
                        <div className="relative h-[500px] lg:h-[700px] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] rounded-none group">
                           <img 
                             src={programsList[activeProgram].img} 
                             onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?auto=format&fit=crop&w=900&q=80'; }}
                             className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" 
                             alt={programsList[activeProgram].title} 
                           />
            ...
            <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 relative -mt-10 z-20">
              ...
              <div className="bg-white rounded-2xl p-8 md:p-10 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.08)] mb-14 flex flex-col md:flex-row items-center gap-8 border border-gray-100 relative z-30">
                <img 
                  ...
                  onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=400&q=80'; }} 
                  alt="Sheldon H." 
              ...
              <div className="mb-20">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <span className="font-black uppercase tracking-[0.25em] text-xs text-[#BE1E2D]">Latest Dispatch • Featured Update</span>
                </div>
                <article className="bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.12)] rounded-2xl overflow-hidden border border-gray-100 group">
                  <div className="relative h-80 sm:h-96 overflow-hidden">
                    <img 
                      ...
                      onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = featuredEntry.heroFallback; }}
                  ...
                  <div className="p-8 sm:p-12">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-8 relative border border-gray-200/80 mb-10">
                      ...
                      <div className="flex items-center space-x-4 border-t border-gray-200/80 pt-4">
                        <img 
                          ...
                          onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = featuredEntry.scoutFallback; }}
                    ...
                    {/* Spotlight Gallery with Eagle Project Photos */}
                      ...
                      <div className="pt-6 border-t border-gray-100">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {featuredEntry.gallery.map((imgSrc, i) => (
                            <div key={i} className="h-64 sm:h-72 rounded-xl overflow-hidden shadow-sm border border-gray-200 bg-gray-50">
                              <img 
                                src={imgSrc} 
                                onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = featuredEntry.galleryFallbacks[i]; }}
                                className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" 
                                alt={`August Action Shot ${i + 1}`} 
                              />
                            </div>
                          ))}
                        </div>
                        ...
                        {isOpen && (
                          <div className="px-6 sm:px-8 pb-8 pt-2 border-t border-gray-100 animate-in fade-in duration-300">
                            <div className="relative h-64 rounded-xl overflow-hidden mb-8 mt-4 border border-gray-100">
                              <img 
                                src={entry.heroImg} 
                                onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = entry.heroFallback; }}
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 relative border border-gray-200/80 mb-6">
                              ...
                              <div className="flex items-center space-x-3 border-t border-gray-200 pt-3">
                                <img 
                                  src={entry.scoutImg} 
                                  onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = entry.scoutFallback; }}
                                  alt={entry.scoutName} 
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  {entry.gallery.map((imgSrc, i) => (
                                    <div key={i} className="h-44 rounded-lg overflow-hidden border border-gray-200 bg-gray-50">
                                      <img 
                                        src={imgSrc} 
                                        onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = entry.galleryFallbacks[i]; }}
                                        className="w-full h-full object-cover" 
                                        alt={`Archive shot ${i}`} 
                                      />
                                    </div>
            ...
            <div className="relative py-40 lg:py-56 px-6 text-center overflow-hidden" style={{ backgroundColor: darkBg }}>
               <div className="absolute inset-0 z-0">
                 <img 
                   ...
                   onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1600&q=80'; }}
               ...
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                 ...
                 <div className="lg:col-span-7 relative h-[500px] lg:h-[650px] mt-10 lg:mt-0">
                    <img 
                      ...
                      onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80'; }}
                      className="absolute top-0 right-0 w-4/5 h-3/4 object-cover shadow-[0_20px_50px_-10px_rgba(0,0,0,0.3)] z-10 rounded-none" 
                      alt="Hiking" 
                    />
                    <div className="absolute bottom-0 left-0 w-2/3 h-3/5 bg-white p-2 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.4)] z-20 rounded-none">
                       <img 
                         ...
                         onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80'; }}
                         className="w-full h-full object-cover" 
                         alt="Sailing" 
                       />
                    </div>
                 ...
                 <div className="lg:col-span-3 p-10 lg:p-14 flex flex-col justify-center bg-white">
                    {joinSuccess ? (
                      <div className="text-center py-10 animate-in zoom-in duration-500">
                         <div className="w-16 h-16 bg-green-50 flex items-center justify-center mx-auto mb-6 rounded-none">
                      ...
                      <form 
                        ...
                        onSubmit={(e) => {
                          ...
                          .catch(() => setJoinErrorMsg("There was a connection issue submitting your inquiry. Please try again or email us directly."));
                        }}
                      >
            ...
            <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
               <div className="bg-white p-10 lg:p-14 shadow-[0_20px_50px_-10px_rgba(29,58,108,0.1)] hover:-translate-y-1 transition-transform flex flex-col justify-between group rounded-none border-t-4 border-[#1D3A6C]">
                  <div>
                    ...
                    <div className="space-y-8">
                       {[
                         ["1", "Observe", "Visit a meeting to see the Patrol Method in action."], 
                         ["2", "Apply", "Submit the official online application."], 
                         ["3", "Outfit", "Obtain your tan uniform and scout handbook."]
                       ].map(([num, title, desc]) => (
            ...
            {!isLoggedIn ? (
              ...
              <div className="pb-32">
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                   ...
                   {/* High Adventure Accomplished Card */}
                   <div className="relative group bg-[#0B0F19] rounded-3xl overflow-hidden border border-white/10 h-64 shadow-2xl md:col-span-2 lg:col-span-3">
                     <div className="absolute inset-0 opacity-40">
                       <img 
                         ...
                         onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80'; }}
                         alt="Sea Base" 
                         className="w-full h-full object-cover"
                       />
                     </div>
                     ...
                     <div className="relative h-full flex flex-col items-center justify-center text-center p-6">
                       <div className="inline-flex items-center space-x-2 bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase mb-3">
                         <CheckCircle2 size={13} />
                         <span>Trek Completed • August 2026</span>
                       </div>
                       <h3 className="text-3xl sm:text-4xl font-black text-white mb-2 uppercase tracking-tight">Sea Base High Adventure</h3>
                       <p className="text-gray-300 text-sm max-w-md mx-auto mb-4 font-light">
                         Sailing, snorkeling, and teamwork in Islamorada, Florida completed with flying colors!
                       </p>
                       <div className="flex items-center space-x-2 text-white/70 text-xs font-medium bg-black/40 px-4 py-1.5 rounded-full border border-white/10">
                         <Anchor size={14} className="text-[#008CFF]" />
                         <span>Troop 170 High Adventure Crew</span>
                       </div>
                     </div>
                   </div>
                </div>

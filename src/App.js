...
export default function App() {
  ...
  }, [leaderAuthUnlocked, currentPage, activeLeader, leaderPinInput, fetchScoutRoster]);
                ...
                <div className="bg-white shadow-2xl border-t-8 border-[#BE1E2D] p-8 md:p-10 rounded-none animate-in fade-in duration-300">
                  ...
                  {!leaderAuthUnlocked ? (
                    <div className="max-w-md mx-auto text-center py-6">
                      ...
                      <p className="text-gray-500 text-xs mb-6">Enter your authorized troop email and leader PIN.</p>
